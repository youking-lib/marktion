...
export class Tokenizer {
  ...
  heading(src) {
    ...
    if (cap) {
      ...
      return {
        ...
        depth: cap[1].length,
        // text,
        children: this.lexer.inline(text),
      }
    }
  }
  ...
  html(src) {
    ...
    if (cap) {
      ...
      if (this.options.sanitize) {
        ...
        token.text = text
        token.children = this.lexer.inline(text)
      }
  ...
  table(src) {
    ...
    if (cap) {
      ...
      if (header.length === item.align.length) {
        item.raw = cap[0]
        ...
        l = header.length
        for (j = 0; j < l; j++) {
          // header[j].tokens = this.lexer.inline(header[j].text)
          header[j].children = this.lexer.inline(header[j].content)
        }
  ...
  lheading(src) {
    ...
    if (cap) {
      return {
        ...
        // text: cap[1],
        children: this.lexer.inline(cap[1]),
      }
    }
  }
  ...
  text(src) {
    ...
    if (cap) {
      return {
        ...
        raw: cap[0],
        // text: cap[0],
        children: this.lexer.inline(cap[0]),
      }
    }
  }
      ...
      while ((match = endReg.exec(maskedSrc)) != null) {
        ...
        if (Math.min(lLength, rLength) % 2) {
          ...
          return {
            ...
            raw,
            // text,
            children: this.lexer.inlineTokens(text),
          }
        }
  ...
  del(src) {
    ...
    if (cap) {
      return {
        ...
        raw: cap[0],
        // text: cap[2],
        children: this.lexer.inlineTokens(cap[2]),
      }
    }
  }
